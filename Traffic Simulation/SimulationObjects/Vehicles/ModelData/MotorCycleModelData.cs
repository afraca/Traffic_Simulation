...
{
    [Serializable]
    public class MotorcycleModelData : VehicleModelData
    {
        public MotorcycleModelData(string name, SizeD size, double speed, double acceleration, double deceleration)
